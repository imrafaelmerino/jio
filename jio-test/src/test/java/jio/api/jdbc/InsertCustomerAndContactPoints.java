...
public class InsertCustomerAndContactPoints implements Lambda<Customer, Long> {
  ...
  public InsertCustomerAndContactPoints(DatasourceBuilder datasourceBuilder,
